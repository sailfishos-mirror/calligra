...
kundo2_aware_xgettext $potfilename *.cpp engine/*.cpp core/*.cpp core/ksp/*.cpp part/chart/*.cpp part/commands/*.cpp part/dialogs/*.cpp functions/*.cpp part/AboutData.h part/*.cpp part/commands/*.cpp part/dialogs/*.cpp ui/*.cpp ui/actions/*.cpp ui/actions/dialogs/*.cpp ui/commands/*.cpp ui/dialogs/*.cpp ui/strategy/*.cpp
rm -f rc.cpp
